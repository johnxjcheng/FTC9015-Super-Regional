...
public class T9015Auto_B_BackHomeRamp extends T9015Hardware {
    private int v_state;
    ...
    public T9015Auto_B_BackHomeRamp(){
    ...
    public void loop(){
        switch(v_state) {
            ...
            case 1:
                ...
                power    = 0.3; //set power
                telemetry.addData("1 - ", "back=" + distance + "p=" + power); //displays distance and power to phone screen
